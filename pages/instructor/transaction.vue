  ...
  <div>
    <NuxtLayout name="default">
      ...
      <template #default>
        ...
        <button class="btn btn-primary text-white block mx-auto my-5" @click="fetchNextPageOfAll" v-if="lastVisible">さらに読み込む<Icon name="ic:round-refresh" size="1.5rem" class="mb-0.5 ml-0.5"/></button>
      </template>
    </NuxtLayout>
  </div>
</template>
...
const { isLoading, lastVisible,  allTransactions, getAllTransactions, fetchNextPageOfAll } =
  useTransactionStore();
