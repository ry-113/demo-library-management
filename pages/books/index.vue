<template>
  ...
  <div v-else v-for="num in 5" :key="num" class="px-5 relative">
    <h2 class="mt-6 text-xl">テスト用</h2>
    <Carousel
      class="carousel carousel-center p-4 space-x-4 bg-stone-100 rounded-box"
      :items-to-show="7"
    >
      <Slide v-for="book in allBooks" :key="book.bookid">
